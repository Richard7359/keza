...
const NewsLetter = () => {
  return (
    <section className="my-10 bg-deepSkyBlue">
    <article className="container mx-auto grid place-items-center md:grid-cols-2 rounded-md w-fit px-3 md:px-0">
      ...
      <div className="py-10 w-full flex justify-center">
        <a className="twitter-timeline" data-width="370" data-height="500"
          href="https://twitter.com/kefl_rw?ref_src=twsrc%5Etfw">Tweets by kefl_rw</a>

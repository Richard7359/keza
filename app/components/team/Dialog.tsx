...
//         </p>
//       </DialogTrigger>
//       {/* <DialogContent className="w-[95%] sm:flex sm:w-[80%] h-[95vh]  overflow-auto p-2"> */}
//       <DialogContent className="w-[95%] sm:flex sm:w-[80%]">
//         <div
//           className=" 
...
//             src={image}
//             alt={names}
//             className="w-[90%] sm:w-full h-[32vh] object-cover rounded-lg bg-image"
//           />
//         </div>

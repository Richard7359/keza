...
const Gadegets = ({ service }: ServiceProps) => {
  return (
    <div className="flex justify-center">
      <div className="py-10 w-[80%]">
        <div className="container mx-auto px-4">
          <h2 className="sm:text-2xl font-bold pb-3 uppercase">{service.title}</h2>
          <div className=" flex flex-col-reverse md:flex-row items-center mt-2 bg-custom-gray rounded-lg">

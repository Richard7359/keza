          ...
          <article className="grid md:grid-cols-2 md:gap-x-14 my-10 px-3 md:px-0">
            ...
            <div className="text-paragraph">
              ...
              <p>
                ...
                schools and non-governmental organizations (NGOs) in their
                pursuit of educational excellence and community development.
                With a wealth of expertise and experience, KEFL offers tailored
                solutions to enhance the effectiveness and impact of educational
                institutions and nonprofit organizations.
              </p>
              <br />
              <p>
                Our services encompass a wide range of areas, including
                curriculum development, teacher training, strategic planning,
                and resource mobilization. We work closely with schools to
                design innovative teaching approaches and programs that promote
                student engagement and achievement. For NGOs, we offer guidance
                on program design, and impact assessment to ensure their
                initiatives make a meaningful difference in the communities they
                serve.
              </p>
              <br />
              <p>
              ...
              <p className="mt-10">
                ...
                <a
                  ...
                  className="font-bold text-burgundy hover:underline hover:underline-offset-4"
                >
                  Contact Us
                </a>
              </p>

...
import CourseTable from "@/app/components/courses/Table";
                      ...
                      <div className="">
                        <div className="">
                          <div className="">
                            ...
                            <p className="text-black font-bold py-1  flex items-center">
                              {selected === "Pre-advanced" ||
                              selected === "advanced"
                                ? "Objective: "
                                : ""}
                            ...
                            <div className="">
                              {selected === "Beginner" ? (
                                <div className=" rounded-sm">
                                  <div className="py-1 font-bold text-sm">
                                  ...
                                  <div className="px-4 py-1 text-sm">
                                    <ul>
                                      ...
                                      <li>
                                        ● Interactive storytelling with blocks
                                      </li>
                                      <li>● Code-a-Pillar Toy Activities</li>
                                      <li>
                                        ● Assembling the Code-a-Pillar to follow
                                        paths
                                      </li>
                                      <li>
                                        ● Simple problem-solving tasks with the
                                        toy
                                      </li>
                                      <li>● Blocks-Based Programming</li>
                                      <li>
                                        ● Basic commands and sequencing with
                                        physical blocks
                                      </li>
                                      <li>
                                        ● Creating simple stories and patterns
                                      </li>
                                      <li>
                                        ● Learning Numbers,Alphabets,animals and
                                        colors by using KEZA GAMING ROBOT
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                                ...
                                <div>
                                  ...
                                  <div className="py-2 mt-2 text-sm">
                                    <strong> Coding:</strong> Etoys and Turtle
                                    Art
                                  </div>
                                ...
                                <div>
                                  ...
                                  <div>
                                    <CourseTable
                                      activity={pre_advanced_activity}
                                    />
                                    <div className="py-2 mt-2 text-sm">
                                      <strong> Coding:</strong> Pictoblox
                                    </div>
                                    <CourseTable
                                      activity={pre_advanced_toy_activity}
                                    />
                                  </div>
                                </div>
                              ) : (
                                <div>
                                  ...
                                  <div>
                                    ...
                                    <CourseTable
                                      activity={advanced_toy_activity}
                                    />
                                  </div>
                                </div>
                              )}

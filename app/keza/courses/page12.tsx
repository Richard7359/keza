                ...
                >
                  ...
                  <AccordionItem value="7" className="border border-none mt-4">
                    ...
                    >
                      <div className="flex items-center">
                        <AiFillApi className="text-3xl" />
                        STEP 7:FULL VIEW OF L2 AND WD&S1&S2
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  <AccordionItem value="17" className="border border-none mt-4">
                    ...
                    >
                      <div className="flex items-center">
                        <CgTally className="text-3xl" /> STEP 17: Plugging B2 into B1
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <AiFillApi className="text-3xl" /> STEP 18: Full view of B1 and B2
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <AiFillApi className="text-3xl" />
                        STEP 25: Full view of 4 Inside parts with LEDs and wires.
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <FaPause className="text-3xl" /> STEP 26: Plugging Inside parts into Model part
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <AiFillApi className="text-3xl" />
                        STEP 29: Full view of Internal side assembly with electronic part.
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <FaVenus className="text-3xl" /> STEP 30: Plugging BATTERY and connecting CABLE
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <FaVenus className="text-3xl" /> STEP 32: Plugging Battery with cable to The traffic light.
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center">
                        <SlBadge className="text-3xl" /> STEP 33: Full View of FINAL Assembly of TRAFFIC LIGHT
                      </div>
                    </AccordionTrigger>
                    <AccordionContent
                      className={`pd_id _c uc ${
